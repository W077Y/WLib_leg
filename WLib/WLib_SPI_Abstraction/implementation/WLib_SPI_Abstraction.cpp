...
namespace WLib::SPI
{
  ...
  namespace
  {
    ...
    public:
      ...
      virtual uint32_t get_actual_clock_rate() const override
      {
        return 0;
      };
  ...
  namespace Internal
  {
    ...
    ChipSelect_Interface& unique_chip_select_wrapper_t::get_native_handle()
    {
      return this->m_chip_select;
    }

    void unique_chip_select_wrapper_t::mutible_selection_error_handler()
    {
      throw mutible_selection_exception_t();
    }
  }    // namespace Internal

  Connection_Interface& Connection_Interface::get_null()
  {
    return null_connection;
  }
  HW_Interface& HW_Interface::get_null()
  {
    return null_hw;
  }
  ChipSelect_Interface& ChipSelect_Interface::get_null()
  {
    return null_cs;
  }
  ...
  uint32_t Channel_Handle::get_actual_clock_rate() const
  {
    return this->m_spi_hw->get_actual_clock_rate();
  }
